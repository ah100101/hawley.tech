...
const workItems = [
  ...
  {
    title:
      "Sitecore Symposium: How to achieve 90+ CWV with XM Cloud and Vercel",
    description:
      "Sitecore Symposium talk on how Avanade improved Core Web Vitals with Next.js & Vercel",
    className: "md:col-span-1",
    icon: <IconTableColumn className="h-4 w-4 text-neutral-500" />,
    imageOverride:
  ...
  },
  {
    ...
    description:
      "A how to get started guide on integrating Contentful with Next.js 13",
    className: "md:col-span-2",
    icon: <IconTableColumn className="h-4 w-4 text-neutral-500" />,
