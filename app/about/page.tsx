  ...
  return (
    <div className="flex flex-col min-h-[calc(100vh-8rem)] bg-black text-white font-sans">
      <main className="flex-grow flex items-center justify-center w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        {/* The content grid is already a single child, so it will be centered by the main tag's flex properties */}
        <div className="grid grid-cols-1 md:grid-cols-3 md:gap-12 items-center w-full">
          ...
          <div className="md:col-span-2 text-center md:text-left">
            ...
            <div className="space-y-4 text-neutral-300 text-base sm:text-lg leading-relaxed">
              <p>
                This is where your longer form summary will go. You can talk about your journey into web development,
                your passions, philosophies on design and technology, and what drives you. Keep it engaging and
                authentic.
              </p>
              <p>
                Perhaps mention key skills or areas of expertise you want to highlight, or a particular approach you
                take to your work. This space is flexible for you to share more about yourself beyond just your work
                experience and projects.
              </p>
              <p>
                Consider what makes you unique as a developer and a person. What are you looking for in your next
