...
export default function DraggablePhotoGallery() {
  ...
  const items = [
    {
      title: "Antarctica",
      description: "Exploring the frozen continent",
      date: "November 2024",
      image: "https://5cjexcwufz95alg5.public.blob.vercel-storage.com/aph/antarctica-2024",
      className: "absolute top-[35%] left-[30%] rotate-[4deg]",
    },
    {
      title: "Kinzie",
      description: "My adventure companion",
      date: "October 2023",
      image: "https://5cjexcwufz95alg5.public.blob.vercel-storage.com/aph/kinzie-2023",
      className: "absolute top-[50%] left-[25%] rotate-[-7deg]",
    },
    {
      title: "Kilimanjaro",
      description: "Summit at sunrise",
      date: "February 2020",
      image: "https://5cjexcwufz95alg5.public.blob.vercel-storage.com/aph/kilimanjaro-2-2020",
      className: "absolute top-[20%] left-[40%] rotate-[8deg]",
    },
    {
      title: "Japan",
      description: "Cherry blossoms in Kyoto",
      date: "April 2018",
      image:
    ...
    {
      title: "Norway",
      description: "Midnight sun over fjords",
      date: "August 2019",
      image:
  ...
  return (
    ...
    >
      {items.map((item, index) => (
        <DraggableCardBody key={index} className={isMobile ? "" : item.className} drag={!isMobile}>
